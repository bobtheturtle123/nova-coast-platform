...
export function buildPaymentEntry({
  ...
  note = null,            // free-text note the recorder typed (manual payments)
  ...
  else if (paymentType === "blocked") title = `An online payment attempt was blocked — payment setup incomplete or routing could not be verified.`;
