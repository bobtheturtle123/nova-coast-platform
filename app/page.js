          ...
          <div className="grid md:grid-cols-2 gap-12 items-end">
            <div className="py-12">
              ...
              <p className="text-white/70 text-lg max-w-xl leading-relaxed mb-10">
                ShootFlow handles booking, deposits, media delivery, and balance collection —
                so you spend less time chasing invoices and more time shooting.
              </p>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="font-serif text-4xl text-navy mb-4 font-normal">Before and after ShootFlow</h2>
            <p className="text-gray-500 max-w-xl mx-auto">Stop managing your business in a mess of texts, spreadsheets, and PayPal requests.</p>
          </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-7">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Email galleries with WeTransfer links",
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <h2 className="font-serif text-4xl text-navy mb-5 font-normal">Give every agent a professional listing kit.</h2>
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-sm">No feature tiers. No nickel-and-diming. Every plan gets the full platform.</p>
          </div>
...
const FEATURES = [
  {
    ...
    desc: "Guided flow walks clients through packages, add-ons, and payment — designed to raise your average order value without extra selling.",
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Balance due reminders + one-click payment",
      "Full or deposit-only payment options",
    ],
  },
  {
    icon: "🖼️",
    title: "Smart media delivery",
    desc: "Deliver galleries with one click. Photos are preview-only until the balance clears — no chasing clients for payment.",
    bullets: [
      "Photo & video upload (up to 1,000 files)",
  ...
  {
    icon: "🏡",
    title: "Property websites & brochures",
    desc: "Every listing gets a branded property website and print-ready brochure — auto-populated from booking data.",
    bullets: [
  ...
  {
    icon: "✨",
    title: "Agent marketing portal",
    desc: "Agents get a private portal with gallery, website, QR code, and AI-generated captions — sent automatically on delivery.",
    bullets: [
      "AI social captions (Instagram, Facebook, email)",
  ...
  },
  {
    ...
    desc: "Every shoot tracked from request to delivered. See revenue, pending payments, and photographer costs in one place.",
    bullets: [
