...
export async function PATCH(req, { params }) {
  ...
  const allowed = ["unlocked", "media", "categories", "categoryOrder", "websiteHiddenCategories", "matterportUrl", "matterportHidden", "videoUrl", "videoUrlHidden", "virtualLinks", "mlsUrl", "floorPlans", "attachedFiles", "authorizedEmails", "agentCanShare"];
  const update = {};
