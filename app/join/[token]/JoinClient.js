    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 max-w-md w-full text-center">
          ...
          <h1 className="text-2xl font-bold text-[#3486cf] mb-2">You&apos;re in!</h1>
          <p className="text-gray-500 text-sm mb-4">
            Welcome to <strong>{companyName}</strong>. Taking you to your dashboard…
          </p>
          <div className="w-5 h-5 border-2 border-[#3486cf]/30 border-t-[#3486cf] rounded-full animate-spin mx-auto" />
        </div>
      </div>
    );
  }
