export const metadata = {
  ...
  alternates: { canonical: "https://kyoriaos.com/privacy" },
  ...
  return (
    <article className="prose prose-sm prose-gray max-w-none">
      ...
      <Section title="6. Cookies and Tracking">
        <p>We use cookies and local storage to keep you authenticated and to save preferences. For details, see our <a href="/cookies">Cookie Policy</a>.</p>
