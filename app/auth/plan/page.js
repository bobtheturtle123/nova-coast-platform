...
const PLANS = [
  {
    ...
    features: ["1 user seat", "120 listings / year", "2% transaction fee"],
    featured: false,
  },
  {
    id:       "studio",
    ...
    features: ["5 team seats", "300 listings / year", "1.5% transaction fee"],
    featured: true,
  },
  {
    id:       "pro",
    name:     "Pro Team",
    price:    279,
    tagline:  "For fast-growing teams",
    features: ["12 team seats", "600 listings / year", "1.25% transaction fee"],
    featured: false,
  },
  {
    id:       "scale",
    ...
    features: ["Unlimited seats", "1,200 listings / year", "1% transaction fee"],
    featured: false,
  },
];
